...
const Features = () => {
  ...
  return (
    <div id='features' className='flex flex-col items-center my-10 scroll-mt-12'>
        ...
        <Title title='Create a Stunning Resume in Minutes' description='SmartCV helps developers and professionals 
        craft beautiful, job-winning resumes instantly. Choose a template, customize your design, and 
        download your CV in seconds.'/>


            <div className="flex flex-col md:flex-row items-center justify-center">
                <img className="max-w-2xl w-full xl:-ml-32" src="https://raw.githubusercontent.com/prebuiltui/prebuiltui/main/assets/features/group-image-1.png" alt="ewarsdgfh" />
